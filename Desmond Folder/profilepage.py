...
"")
        ...
        self.user_pic.setPixmap(QtGui.QPixmap("D:\\Documents (Extras)\\Additional Program Files\\PycharmProjects\\DoctorApp\\profile 2.jpg"))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.username_show.setText(_translate("MainWindow", u_username))
        ...
        self.FirstName_input.setPlaceholderText(_translate("MainWindow", u_firstname))
        self.LastName_input.setPlaceholderText(_translate("MainWindow", u_lastname))
        self.MobileNumber_input.setPlaceholderText(_translate("MainWindow", u_mobilenumber))
        self.MobileNumber.setText(_translate("MainWindow", "Mobile Number"))
        self.Email.setText(_translate("MainWindow", "Email"))
        self.Email_input.setPlaceholderText(_translate("MainWindow", u_email))
        self.Gender.setText(_translate("MainWindow", "Gender"))
        self.save_profile_button.setText(_translate("MainWindow", "save profile"))
        self.Gender_input.setPlaceholderText(_translate("MainWindow", u_gender))

    def save_profile(self, MainWindow):
            # Get input values
            firstname = self.FirstName_input.text().strip()
            lastname = self.LastName_input.text().strip()
            mobilenumber = self.MobileNumber_input.text().strip()
            ...
            if firstname:
                db.child("user").child(u_username).update({"firstname": firstname})

            if lastname:
                db.child("user").child(u_username).update({"lastname": lastname})

            if mobilenumber:
                db.child("user").child(u_username).update({"mobilenumber": mobilenumber})

            if gender:
                db.child("user").child(u_username).update({"gender": gender})
